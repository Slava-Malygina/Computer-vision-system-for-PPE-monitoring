### Цель проекта:
 ...
 Разработать систему компьютерного зрения для обнаружения средств индивидуальной защиты (СИЗ) - касок, перчаток и жилеток при входе на предприятие и ведёт журнал нарушений. Это позволит автоматически проверять наличие СИЗ у входящих людей, минимизируя риски на производстве или стройплощадках.
